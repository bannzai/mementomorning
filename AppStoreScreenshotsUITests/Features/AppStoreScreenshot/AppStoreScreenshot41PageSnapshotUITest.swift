...
/// AppStoreScreenshot41Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot41PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot41Page_Previews"
