...
/// AppStoreScreenshot7Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot7PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot7Page_Previews"
