...
/// AppStoreScreenshot35Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot35PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot35Page_Previews"
