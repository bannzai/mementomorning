...
/// AppStoreScreenshot29Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot29PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot29Page_Previews"
