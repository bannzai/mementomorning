...
/// AppStoreScreenshot19Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot19PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot19Page_Previews"
