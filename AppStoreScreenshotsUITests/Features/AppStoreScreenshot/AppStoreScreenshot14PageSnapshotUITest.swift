...
/// AppStoreScreenshot14Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot14PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot14Page_Previews"
