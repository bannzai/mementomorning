...
/// AppStoreScreenshot16Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot16PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot16Page_Previews"
