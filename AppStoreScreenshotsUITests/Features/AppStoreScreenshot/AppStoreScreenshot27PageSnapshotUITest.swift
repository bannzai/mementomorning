...
/// AppStoreScreenshot27Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot27PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot27Page_Previews"
