...
/// AppStoreScreenshot18Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot18PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot18Page_Previews"
