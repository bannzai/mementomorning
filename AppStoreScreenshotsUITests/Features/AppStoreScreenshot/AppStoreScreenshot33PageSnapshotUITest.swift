...
/// AppStoreScreenshot33Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot33PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot33Page_Previews"
