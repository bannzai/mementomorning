...
/// AppStoreScreenshot30Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot30PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot30Page_Previews"
