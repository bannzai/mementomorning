...
/// AppStoreScreenshot38Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot38PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot38Page_Previews"
