...
/// AppStoreScreenshot26Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot26PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot26Page_Previews"
