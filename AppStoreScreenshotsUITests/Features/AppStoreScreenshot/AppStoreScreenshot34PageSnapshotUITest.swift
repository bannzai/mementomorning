...
/// AppStoreScreenshot34Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot34PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot34Page_Previews"
