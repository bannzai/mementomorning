...
/// AppStoreScreenshot25Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot25PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot25Page_Previews"
