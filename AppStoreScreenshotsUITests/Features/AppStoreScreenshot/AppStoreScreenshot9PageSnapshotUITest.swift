...
/// AppStoreScreenshot9Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot9PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot9Page_Previews"
