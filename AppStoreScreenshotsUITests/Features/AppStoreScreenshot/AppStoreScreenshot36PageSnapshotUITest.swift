...
/// AppStoreScreenshot36Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot36PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot36Page_Previews"
