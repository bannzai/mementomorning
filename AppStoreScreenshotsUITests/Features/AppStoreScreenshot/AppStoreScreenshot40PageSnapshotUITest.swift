...
/// AppStoreScreenshot40Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot40PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot40Page_Previews"
