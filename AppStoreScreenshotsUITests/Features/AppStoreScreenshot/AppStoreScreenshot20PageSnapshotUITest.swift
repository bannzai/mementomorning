...
/// AppStoreScreenshot20Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot20PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot20Page_Previews"
