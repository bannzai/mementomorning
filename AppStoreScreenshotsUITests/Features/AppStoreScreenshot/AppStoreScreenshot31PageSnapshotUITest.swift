...
/// AppStoreScreenshot31Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot31PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot31Page_Previews"
