...
/// AppStoreScreenshot37Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot37PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot37Page_Previews"
