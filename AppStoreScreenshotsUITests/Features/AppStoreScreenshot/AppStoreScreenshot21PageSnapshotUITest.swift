...
/// AppStoreScreenshot21Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot21PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot21Page_Previews"
