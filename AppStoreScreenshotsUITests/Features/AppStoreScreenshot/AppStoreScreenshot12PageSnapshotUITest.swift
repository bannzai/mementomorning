...
/// AppStoreScreenshot12Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot12PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot12Page_Previews"
