...
/// AppStoreScreenshot24Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot24PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot24Page_Previews"
