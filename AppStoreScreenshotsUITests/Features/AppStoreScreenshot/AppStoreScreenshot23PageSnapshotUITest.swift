...
/// AppStoreScreenshot23Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot23PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot23Page_Previews"
