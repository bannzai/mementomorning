...
/// AppStoreScreenshot28Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot28PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot28Page_Previews"
