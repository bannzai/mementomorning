...
/// AppStoreScreenshot10Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot10PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot10Page_Previews"
