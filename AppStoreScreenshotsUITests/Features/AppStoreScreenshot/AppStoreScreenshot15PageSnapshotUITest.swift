...
/// AppStoreScreenshot15Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot15PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot15Page_Previews"
