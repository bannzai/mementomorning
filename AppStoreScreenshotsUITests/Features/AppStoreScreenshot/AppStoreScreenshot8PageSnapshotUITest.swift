...
/// AppStoreScreenshot8Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot8PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot8Page_Previews"
