...
/// AppStoreScreenshot22Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot22PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot22Page_Previews"
