...
/// AppStoreScreenshot13Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot13PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot13Page_Previews"
