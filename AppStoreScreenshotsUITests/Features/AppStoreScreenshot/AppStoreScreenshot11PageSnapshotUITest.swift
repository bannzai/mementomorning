...
/// AppStoreScreenshot11Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot11PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot11Page_Previews"
