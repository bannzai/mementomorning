...
/// AppStoreScreenshot17Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot17PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot17Page_Previews"
