...
/// AppStoreScreenshot42Page を全対象言語で撮影する SnapshotUITest。
...
final class AppStoreScreenshot42PageSnapshotUITest: XCTestCase {
    ...
    let previewType = "AppStoreScreenshot42Page_Previews"
