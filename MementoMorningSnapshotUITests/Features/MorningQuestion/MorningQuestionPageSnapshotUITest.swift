...
/// MorningQuestionPage の Preview を全対象言語で撮影する SnapshotUITest。
/// XCTAttachment 名 ({file}---{function}---{language}---{index}) を
/// scripts/snapshot_ui_tests/organize_screenshots.sh が解析して言語別に整理する
final class MorningQuestionPageSnapshotUITest: XCTestCase {
    ...
    let previewType = "MorningQuestionPage_Previews"
